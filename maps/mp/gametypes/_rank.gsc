...
//================================================================================================
// Zombotron: Added
	registerScoreInfo( "testzomkill", level.testzom_killpoints );
	registerScoreInfo( "bosszomkill", level.BossZom_killpoints );
//================================================================================================
...
onPlayerSpawned()
{
	...
	for(;;)
	{
		...
		if(!isdefined(self.hud_rankscroreupdate))
		{
			...
			self.hud_rankscroreupdate.glowAlpha = 0.1;
...
//================================================================================================
// Zombotron: Unlock camo and gold at certain rank lvl
		if(self.pers["rank"] == 49)
		{
			...
			for(i=0; i < keys.size; i++)
			{
				...
				{
					self unlockAttachment( level.challengeInfo[keys[ i ]]["attachment"] );
				}
    				wait 0.1;
			}
			self iPrintln("You have been awarded unlocked attachments for all weapons!");
		}

		if(self.pers["rank"] == 59)
		{
			keys = getArrayKeys( level.challengeInfo );
			for(i=0; i < keys.size; i++)
			{
				...
				{
					self unlockCamo( level.challengeInfo[keys[ i ]]["camo"] );
				}
				wait 0.1;
			}
			self iPrintln("You have been awarded all camo skins for all weapons!");
		}

		if(self.pers["rank"] == 64)
		{
			self unlockCamo( "ak47 camo_gold" );
			wait 0.05;
			self unlockCamo( "uzi camo_gold" );
			wait 0.05;
			self unlockCamo( "m60e4 camo_gold" );
			wait 0.05;
			self unlockCamo( "m1014 camo_gold" );
			wait 0.05;
			self unlockCamo( "dragunov camo_gold" );
			self iPrintln("You have been awarded gold skinned weapons!");
		}
//================================================================================================
		// unlocks weapon =======
...
///////////// Changed By KiLL3R //////////
			self.hud_rankscroreupdate.color = (1,1,1); //(1,1,0.5);
//////////////////////////////////////////
		}
...
incRankXP( amount )
{
	if ( !level.rankedMatch || getDvarInt( "btd_disable_xpgains" ) == 1 )
		return;
