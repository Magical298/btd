...
//================================================================================================
// Zombotron: Spam reduction as this var starts as undefined and thus cannot be incremented.
...
//================================================================================================
	...
	}// Zombotron: Added ac130
	else if ( data.hardpointType == "airstrike_mp" || data.hardpointType == "ac130_mp" )
	{
		player processChallenge( "ch_airstrike" );

		if ( player.pers[data.hardpointType] >= 2 )
			player processChallenge( "ch_afterburner" );
	}// Zombotron: Added blackhawk
	else if ( data.hardpointType == "helicopter_mp" || data.hardpointType == "blackhawk_mp" )
	{
...
ch_kills( data, time )
{
	// Zombotron: Zombies are already dead!!
...
//================================================================================================
	...
	else if ( isSubStr( data.sMeansOfDeath,	"MOD_MELEE" ) )
	{
		...
		if ( player.pers["meleeKillStreak"] == 6 )
