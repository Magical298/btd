...
// Zombotron: Added
	...
	{
		iPrintlnBold("^1ERROR: ^3Gametype is not BTDz compatible. Switching.");
		setDvar("g_gametype","sur");
		setDvar("sv_maprotationcurrent", "gametype sur map " + getDvar("mapname"));
		wait 2;
		exitlevel(false);
	}
	else
	{
		thread btd\_pezbot_devmode::main();
	}
//================================================================================================
}
