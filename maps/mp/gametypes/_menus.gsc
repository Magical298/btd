...
//================================================================================================
// Zombotron: Client commands menu. EDIT: Causes problems with client - removed
/*
...
//================================================================================================
// Zombotron: Removed to make room
...
//			self maps\mp\gametypes\_objpoints::updatePlayerObjpoints();
		...
		else if ( !level.console )
		{
			if(menu == game["menu_quickcommands"])
				btd_menus\ingame_menu\_quickmessages_menu_response::quickcommands(response);
			else if(menu == game["menu_quickstatements"])
				btd_menus\ingame_menu\_quickmessages_menu_response::quickstatements(response);
			else if(menu == game["menu_quickresponses"])
				btd_menus\ingame_menu\_quickmessages_menu_response::quickresponses(response);
		}
